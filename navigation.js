...
function authenticate() {
    ...
    if (username === "e" && password === "d") {
        document.querySelector(".container").style.display = "none";
        document.querySelector(".form-container").style.display = "block";
    } else {
        alert("Invalid credentials wrong password. Please try again.");
    }
}
...
var date = document.querySelector(".date").value;
    ...
    document.querySelector('.nemani1').innerHTML = drawnName;
    document.querySelector('.akash1').innerHTML = checkedName;
    document.querySelector('.prc').innerHTML = checkedName;
    document.querySelector('.div40').innerHTML = date;
    // Add similar lines for other content fields
...
// function moveToNext(event, nextElementclass) {
//     if (event.keyCode === 13) { // 13 is the keycode for Enter
//         event.preventDefault();
//         document.getElementById(nextElementclass).focus();
//     }
//     return false;
// }
...
function moveToNext(event, nextElementClass) {
    if (event.keyCode === 13) { // 13 is the keycode for Enter
        event.preventDefault();
        document.querySelector('.' + nextElementClass).focus();
    }
    return false;
}
